...
class E05Fraccion:
    ...
    def multiplicar_entero(self, numero):
    ...
    def sumar(self, fraccion):
        mcm = (self.denominador * fraccion.denominador) / (E05Fraccion.mcd(self.denominador, fraccion.denominador))
    ...
    def simplificar(self):
        mcd = E05Fraccion.mcd(self.numerador, self.denominador)
