...
Realizar un algoritmo que pida numeros (se pedira por teclado la cantidad de numeros a introducir). El programa debe
informar de cuantos numeros introducidos son mayores que 0, menores que 0 e iguales a 0.
"""
